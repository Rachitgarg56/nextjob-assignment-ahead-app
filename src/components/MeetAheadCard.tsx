...
const MeetAheadCard: React.FC = () => {
  return (
    <div className="px-4 lg:px-20 relative mt-7 mb-16">
      <div
        className="bg-bgPeach overflow-hidden relative flex rounded-lg flex-col md:flex-row h-[470px] md:h-[450px]"
      >
