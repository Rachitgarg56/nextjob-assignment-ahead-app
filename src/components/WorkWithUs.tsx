...
const WorkWithUs: React.FC = () => {
  return (
    <div className="px-4 lg:px-20 md:-my-8 lg:my-32">
      <section className="mt-16 rounded-2xl bg-violet-100 p-4 md:p-8 lg:px-16">
        ...
        <div className="mt-12 flex flex-col md:flex-row gap-16 lg:gap-20 overflow-hidden">
          <div className="grow">
